...
from nemo.collections.multimodal.speech_llm.data.lhotse_dataset import LhotseAudioQuestionAnswerDataset, LhotseAudioChatDataset
...
def build_speechllm_dataset(model_instance, data_cfg, is_train):
    ...
    if data_cfg.get("use_lhotse"):
        ...
        # )
        return LhotseAudioChatDataset(
            tokenizer=model_instance.tokenizer,
            audio_locator=data_cfg["audio_locator"],
        )
