...
class ModularAudioGPTModel(SpeechLLMAdapterMixin, MegatronGPTSFTModel):
    ...
    def configure_sharded_model(self):
        """Modified from the same method in MegatronBaseModel to include speech encoder and modality adapter."""
        ...
        if self.use_fsdp:
            ...
            # NOTE(yifanp): exclude embedding layer to avoid errors in inject_perception_input
    ...
    def restore_from_pretrained_models(
        ...
        if cfg.model.load_audio_encoder:
            ...
            logging.info(f"Audio encoder not loaded as cfg.model.load_audio_encoder is set to {cfg.model.load_audio_encoder}")
